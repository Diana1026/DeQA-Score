...
python src/evaluate/cal_plcc_srcc.py \
	...
	--pred_paths $res_dir/test_agiqa_3k_quality.json \
	--gt_paths $gt_dir/AGIQA3K/metas/test_agiqa_3k.json \
	 --target_key mos_align
	# $res_dir/test_koniq_2k.json \
	...
	# $gt_dir/KONIQ/metas/test_koniq_2k.json \
